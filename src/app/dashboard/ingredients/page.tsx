...
import { IngredientsList } from './_components/list'
...
export default async function IngredientsPage() {
  ...
  const [{ rows, total }, categories] = await Promise.all([
    listIngredients(orgId, { limit: 200 }),
  ...
  return (
    <div className="mx-auto max-w-7xl">
      <div className="mb-6 flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-semibold text-white">Ingredients</h1>
      ...
      <IngredientsList initialRows={rows} categories={categories} />
    </div>
  )
}
